...
// LLM Response Types - Strict JSON Schemas

/**
 * Stage A: Market Filtering Response
 * Quick scan to find relevant markets
 */
...
/**
 * Stage B: Impact Analysis Response  
 * Deep analysis with trading decision
 */
export interface GPTMarketAnalysisResponse {
  market_id: string
  sentiment: 'POSITIVE' | 'NEGATIVE' | 'NEUTRAL'
  impact_score: number
  confidence: number
